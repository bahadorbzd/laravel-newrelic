...
class Newrelic
{
    ...
    {
        return $this->call('newrelic_start_transaction', array($this->applicationName));
    }
     ...
     * @return mixed
     */
    public function addCustomTracer(string $functionName)
    {
        return $this->call('newrelic_add_custom_tracer', array($functionName));
    }
     ...
     * @return string
     */
    public function getBrowserTimingHeader(bool $flag = true)
    {
     ...
     * @return string
     */
    public function getBrowserTimingFooter(bool $flag = true)
    {
